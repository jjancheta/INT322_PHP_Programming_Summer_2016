        ...
        <div class="wrapper">
            ...
            <?php if ($showSidebar): ?>
                <div id="dokuwiki__aside"><!--<div class="pad include">-->
                    ...
                    <ul>
                        <li><a href="doku.php?do=admin&page=usermanager">Add User</a></li>
                        <li><a href="doku.php?do=admin&page=backup">Backup Wiki</a></li>
                        <li><a href="doku.php?id=start&do=register">Register</a></li>
                        <?php
                            tpl_action('media', 1, 'li');
                            tpl_action('index', 1, 'li');
  
                        ?>
                        <li><a href="doku.php?id=others">Other Plugins</a></li>
                    </ul>                
