    ...
    function misc_data_xhtml(&$renderer,$no_align=false,$which='all') {
       ...
       if($which == 'all' || $which == 'misc') {
        ...
        $this->sort($countries);
           ...
           $renderer->doc .= '<span class="title" style="font-weight:bold;
    font-size: 125%;">Countries</span>';
              ...
              $renderer->doc .= '</table>';         
              $renderer->doc .= "<span class='total'>" .$this->getLang('ttl_countries') . (count($this->misc_data['country']) -1)   . "</span></br>";
