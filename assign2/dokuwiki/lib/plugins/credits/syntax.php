    ...
    $settings = array(
           'background_color'=>'#FFDD99', 'pop_up_color'=>'#006600', 'pop_up_weight'=>'normal',
            'text_weight'=> 'bold','email_text_size'=> '95%','text_size'=>'90%',
             ...
             'pop_up_family' =>'Helvetica,Arial,sans-serif', 'title_string' => '<b style="font-size: 125%; color:black;">Plugins</b>',
              'subtitle_string'=>'<b style="font-size: 125%; color:black;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCredits</b><br>',
              'do_desc' => true
            );
